...
@interface AlbumPrefSettingsController : PSListController
{
	UILabel* _label;
	UILabel* underLabel;
}
@property(nonatomic) NSMutableDictionary* albumList;
- (void)HeaderCell;
@end

@implementation AlbumPrefSettingsController
@synthesize albumList;
- (void)loadAlbums
{
	albumList = [[NSMutableDictionary alloc] init];
...
- (id)specifiers {
	if (!_specifiers) {
		...
		spec = [PSSpecifier preferenceSpecifierNamed:@"Heart Button"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"Heart" forKey:@"key"];
		[spec setProperty:@YES forKey:@"default"];
        [specifiers addObject:spec];
		spec = [PSSpecifier preferenceSpecifierNamed:@"Select Album"
                                                  target:self
											         set:@selector(setPreferenceValue:specifier:)
											         get:@selector(readPreferenceValue:)
											  ...
											  cell:PSLinkListCell
											        edit:Nil];
		[spec setProperty:@"albumId" forKey:@"key"];
		[spec setProperty:@"default" forKey:@"default"];
		[spec setValues:[albumList allKeys] titles:[albumList allValues]];
        [specifiers addObject:spec];
        ...
        [specifiers addObject:spec];
		spec = [PSSpecifier emptyGroupSpecifier];
        [spec setProperty:@"AlbumPref © 2020" forKey:@"footerText"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#AlbumPref by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)setPreferenceValue:(id)value specifier:(PSSpecifier *)specifier
{
	@autoreleasepool {
		...
		Prefs[@"albumName"] = albumList[value];
		[Prefs writeToFile:@PLIST_PATH_Settings atomically:YES];
		notify_post("com.julioverne.albumpref/SettingsChanged");
...
- (void)HeaderCell
{
	@autoreleasepool {
		...
		[underLabel setText:@"Choose Preferred Album in Messages"];
